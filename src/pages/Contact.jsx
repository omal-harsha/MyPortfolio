...
export const Contact = () => {
  ...
  return (
    <div id='contact' className='bg-bgBlack flex lg:pl-40 md:justify-between md:pl-20 md:flex-row sm:flex-col-reverse sm:pb-10 md:pb-0 pt-10 md:pt-16 lg:pt-0'>
      ...
      >
        {/* web screen */}
        <img src='https://firebasestorage.googleapis.com/v0/b/blogsite-33dcd.appspot.com/o/myPhoto%2Fcontact(web).png?alt=media&token=ec6dcda3-1c73-4ad6-9517-990b9a65d11b' className='w-[800px] '/>
      </div>

      {/* mobile screen */}
      <div classname='md:hidden'>        
        <img src='https://firebasestorage.googleapis.com/v0/b/blogsite-33dcd.appspot.com/o/myPhoto%2Fcontact(mobile).png?alt=media&token=9b21f084-179b-4f73-bdda-2be69beaad90' className=' w-[300px] self-end '/>
      </div>
      </div>
  )
}
